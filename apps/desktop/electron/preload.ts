...
const api: DesktopApi = {
  ...
  settings: {
    ...
    addProject:       (args)     => ipcRenderer.invoke(CHANNEL.settingsAddProject, args),
    renameProject:    (id, newName) => ipcRenderer.invoke(CHANNEL.settingsRenameProject, id, newName),
    deleteProject:    (id)       => ipcRenderer.invoke(CHANNEL.settingsDeleteProject, id),
    setActiveProject: (id)       => ipcRenderer.invoke(CHANNEL.settingsSetActiveProject, id),
