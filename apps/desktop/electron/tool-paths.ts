...
function candidateDirs(): string[] {
  ...
  return [
    ...
    join(managedToolsDir(), 'go-ios', platformKey(), 'bin'),
    join(managedToolsDir(), 'go-ios', 'bin'),
    join(managedToolsDir(), 'uxplay', platformKey(), 'bin'),
    join(managedToolsDir(), 'uxplay', 'bin'),
    resourcesPath ? join(resourcesPath, 'vendor', 'go-ios', platformKey(), 'bin') : null,
    resourcesPath ? join(resourcesPath, 'vendor', 'go-ios', 'bin') : null,
