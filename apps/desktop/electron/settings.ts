...
import type { AppLocale, AppSettings, BugSeverity, GitLabMentionUser, GitLabPublishSettings, HotkeySettings, MentionIdentity, SeveritySettings, SlackChannel, SlackMentionUser, SlackPublishSettings } from '@shared/types'
