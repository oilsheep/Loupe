...
function settings(): AppSettings {
  return {
    ...
    google: { token: 'ya29-test', refreshToken: '', tokenExpiresAt: Date.now() + 3600_000, accountEmail: 'qa@example.com', oauthClientId: 'google-client', oauthRedirectUri: 'http://127.0.0.1:38988/oauth/google/callback', driveFolderId: 'folder-root', driveFolderName: 'Loupe', updateSheet: false, spreadsheetId: '', spreadsheetName: '', sheetName: '' },
    mentionIdentities: [],
  }
}
